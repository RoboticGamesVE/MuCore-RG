...
<div align="right" style="width: 100%; margin-bottom: 2px;"><a href="index.php?get=logs_agm_credits_manager">[View Today Logs]</a></div>
		...
		<div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card" style="margin-bottom: 0px;">
					<div class="header">
						<h2 style="text-align: center;">
							AGame Master MU Coins Manager Logs
						</h2>
					</div>
					<div class="body">
