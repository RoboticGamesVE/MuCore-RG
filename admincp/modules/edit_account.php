...
<section class="content" style="width: 95%;margin: 0 auto 0 auto;">
	<div class="container-fluid">
		...
		<div class="row clearfix">
                        ...
                        <table class="table table-striped">
								...
								if ($_POST['search_t'] == '1') {
                					...
                					while (!$user->EOF) {
                    					...
                    					echo '
										<tr>
            <th scope="row"><strong>' . htmlspecialchars($user->fields[1]) . '</strong></th>
            <td>' . htmlspecialchars($user->fields[2]) . '</td>
            <td>';
            ...
            <td>' . getcountry($user->fields[4]) . '</td>
            <td><a href="index.php?get=edit_account&mod=edit&id=' . $user->fields[0] . '">[Edit]</a></td>
            </tr>';
                    					$user->MoveNext();
                					}
                
                					if ($count == '0') {
                    					echo '<tr><td>No Accounts Found</td></tr>';
                					}
