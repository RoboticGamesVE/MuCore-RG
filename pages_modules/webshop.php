            ...
            while(!$select_items->EOF){
                ...
                if($class_pressent == '1'){
                    ...
                    if($_SESSION['admin_login_auth']){
                            echo '<div align="center" style="margin-top:10px;margin-bottom:10px;"><a href="'.$core['admincp'].'admincp/index.php?get=webshop_item_manager&m=edit&id='.$select_items->fields[0].'" target="_blank">[-Edit Item-]</a></div>';
                        }
                        echo'
                        </div>
                        ';
