    ...
    if ( isset( $_GET['sid'] ) )
    {
        ...
        else
        {
            ...
            else
            {
                ...
                $update_stats = $core_db->Execute( "Update Character set [LevelUpPoint] =[LevelUpPoint]+[Strength]+[Strength]+[Dexterity]+[Vitality]+[Energy]+[Leadership]-150,Strength='25',Dexterity='25',Vitality='25',Energy='25',Leadership='25' where mu_id=?", array($id, $total_points));
