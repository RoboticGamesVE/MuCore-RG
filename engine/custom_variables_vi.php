...
$characters_class = array (
  ...
  83=> array('Dimention Master','sm.gif'),
  96=> array('Rage Fighter','rf.gif'),
  97=> array('Fist Master','rf.gif'),
  98=> array('Fist Master','rf.gif'),
...
$secret_questions = array(
   1 => 'Tên người yêu bạn là gì?',
   2 => 'Tên người bạn thân của bạn?',
   3 => 'Tên con vật nuôi yêu thích của bạn?',
   4 => 'Ai là người hùng trong lòng bạn?',
   5 => 'Tụ điểm đi chơi bạn yêu thích ở đâu?',
   6 => 'Bạn yêu thích nhân vật hoạt hình nào?',
   7 => 'Số điện thoại của bạn?',
   8 => 'Số CMND của bạn?',
   9 => 'Nhà bạn ở đâu?',
   10 => 'Trò chơi yêu thích của bạn?',
